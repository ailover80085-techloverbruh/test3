...
<div id="wrapper">
    ...
    <div id="content">
		...
		<h1>ABOUT US</h1><br>
				...
				<table style="width: 80%; margin: 2rem auto; text-align: left;">
				  <tr>
					<th style="width: 50%; text-align: center;"><h3>Mission</h3></th>
					<th style="width: 50%; text-align: center;"><h3>Vision</h3></th>		
				  </tr>
				  <tr>
				  	<td style="width: 50%; text-align: left;">To provide superior transport service to Metro Manila and Mindoro Province commuters. 
					</td>
					
					<td style="width: 50%; text-align: center;">To lead the bus transport industry through its innovation service to the riding public. 
					</td>		
